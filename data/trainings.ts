...
type TemplateDefinition = {
  ...
  instructor: string
  instructorBio: string
  description: (seed: ProgramSeed) => string
  whatYouLearn: (seed: ProgramSeed) => string[]
  requirements: (seed: ProgramSeed) => string[]
  curriculum: (seed: ProgramSeed) => TrainingProgram["curriculum"]
  testimonials: (seed: ProgramSeed) => TrainingTestimonial[]
}
...
const focusLabel = (seed: ProgramSeed) => seed.focus ?? seed.title

const makeTestimonials = (seed: ProgramSeed, presets: TestimonialPreset[]): TrainingTestimonial[] =>
  presets.map((preset) => ({
    name: preset.name,
    role: preset.role,
...
const testimonialPresets: Record<TemplateKey, TestimonialPreset[]> = {
  programming: [
    {
      name: "Souleymane Bah",
...
const programTemplates: Record<TemplateKey, TemplateDefinition> = {
  programming: {
    level: "Intermédiaire",
      ...
      return [
        {
          ...
          lessons: ["Environnement VS Code & Git", `${focus} patterns essentiels`, "Qualité & tests rapides", "Mini-projet guidé"],
        },
        {
          title: "Projet encadré",
          lessons: ["Cadrage client", "Sprints & revues", "Tests end-to-end & monitoring", "Déploiement & support"],
        },
        {
          title: "Portfolio & offre",
          lessons: ["Documentation livrable", "Pitch & storytelling", "Tarification", "Plan d'amélioration"],
        },
      ]
    },
      ...
      return [
        {
          ...
          lessons: ["Diagrammes & normalisation", `${focus} optimisation d'index`, "Requêtes analytiques", "Data quality checks"],
        },
        {
          title: "Ops & automatisation",
          lessons: ["Migrations versionnées", "Backups & réplication", "Monitoring & alerting", "Security & gouvernance"],
        },
        {
          title: "Projet data",
          lessons: ["Collecte & nettoyage", "Dashboard ou API", "Storytelling", "Plan d'amélioration"],
        },
      ]
    },
      ...
      return [
        {
          ...
          lessons: ["Panorama modèles", "Prompt factories", "Évaluation & guardrails", `${focus} stack overview`],
        },
        {
          title: "Automatisation & agents",
          lessons: ["Make/Zapier + webhooks", "Connecteurs WhatsApp", "LangChain/Ollama", "Prototype livrable"],
        },
        {
          title: "Business & livraison",
          lessons: ["Diagnostic process", "Offre & pricing", "Contrats + SLA", "Onboarding clients"],
        },
      ]
    },
      ...
      return [
        {
          ...
          lessons: ["Adressage IPv4/v6", "Subnetting express", "Switching & VLAN", "Sécurité physique & câblage"],
        },
        {
          title: "Labs avancés",
          lessons: ["OSPF/EIGRP", "Services DHCP/DNS", `${focus} troubleshooting`, "WAN & VPN"],
        },
        {
          title: "Certification & automation",
          lessons: ["Simulations d'examen", "Ansible & sauvegardes", "Monitoring NetFlow", "Plan d'étude"],
        },
      ]
    },
  ...
  linux: {
    ...
    requirements: () => ["Machine Linux/WSL", "Notions de réseau", "Curiosité pour la ligne de commande"],
    curriculum: (seed) => {
      const focus = focusLabel(seed)
      return [
        {
          title: "Shell & productivité",
          lessons: ["Pipelines & regex", "Scripts d'inventaire", "Gestion de logs", `${focus} exercices guidés`],
        },
        {
          title: "Administration système",
          lessons: ["Systemd & services", "Gestion utilisateurs & ACL", "Stockage & backup", "Automatisation Ansible"],
        },
        {
          title: "Sécurité & monitoring",
          lessons: ["Hardening SSH", "Firewall & fail2ban", "Audit Lynis", "Stack observabilité"],
        },
      ]
    },
  ...
  devops: {
    ...
    requirements: () => ["Bases Linux", "Expérience dev ou infra", "Accès à une VM ou cloud"],
    curriculum: () => [
      {
        title: "Containerisation",
        lessons: ["Docker multi-stage", "Registries & scan", "Compose prod", "Policies de sécurité"],
      },
      {
        title: "Orchestration & cloud",
        lessons: ["Kubernetes k3s", "Ingress & TLS", "Terraform/IaC", "Secrets & vault"],
      },
      {
        title: "Ops & livraison",
        lessons: ["CI/CD GitHub Actions", "Grafana/Loki", "Runbook client", "Handover + support"],
      },
    ],
  ...
  security: {
    ...
    requirements: () => ["Bases Linux & réseaux", "Machine dédiée ou lab virtuel", "Éthique irréprochable"],
    curriculum: () => [
      {
        title: "Recon & exploitation",
        lessons: ["OSINT & mapping", "Scan/Rustscan", "Exploits & privesc", "Automation scripts"],
      },
      {
        title: "Ciblage spécifique",
        lessons: ["Web/API pentest", "AD & Red Team", "Crypto & protocoles", "Reporting structuré"],
      },
      {
        title: "Offre & conformité",
        lessons: ["Modèles de rapport", "Roadmap corrective", "Pitch offre récurrente", "Gestion client"],
      },
    ],
  ...
  business: {
    ...
    requirements: () => ["Être prêt à publier", "1h par jour pour exécuter", "Volonté de vendre"],
    curriculum: () => [
      {
        title: "Audience & contenu",
        lessons: ["Avatar client", "Storytelling", "Short-form & lives", "CTA & automatisation"],
      },
      {
        title: "Monétisation",
        lessons: ["Offre & pricing", "Funnels simples", "Automations WhatsApp", "Email minimaliste"],
      },
      {
        title: "Vente & suivi",
        lessons: ["Scripts DM", "Onboarding clients", "Tableau de bord KPI", "Optimisation hebdo"],
      },
    ],
  ...
  skills: {
    ...
    requirements: () => ["Laptop opérationnel", "Motivation à pratiquer", "Connexion stable"],
    curriculum: (seed) => {
      const focus = focusLabel(seed)
      return [
        {
          title: "Fondations",
          lessons: ["Outils & raccourcis", `${focus} bonnes pratiques`, "Livrables attendus", "Checklist qualité"],
        },
        {
          title: "Projets",
          lessons: ["Mini-projet hebdo", "Feedback pair", "Amélioration continue", "Documentation simple"],
        },
        {
          title: "Portfolio",
          lessons: ["Template Notion/Behance", "Pitch oral", "Plan 30 jours", "Suivi personnalisé"],
        },
      ]
    },
  ...
  trading: {
    ...
    requirements: () => ["Compte démo ou réel régulé", "Discipline quotidienne", "Connexion fiable"],
    curriculum: () => [
      {
        title: "Fondamentaux marché",
        lessons: ["Structure & liquidité", "Macro & news", "Journalisation", "Psychologie trader"],
      },
      {
        title: "Stratégies",
        lessons: ["Setups intraday", "Swing & position", "Crypto/forex actions", "Automatisation légère"],
      },
      {
        title: "Discipline & scaling",
        lessons: ["Gestion du risque", "Revues hebdo", "Plan de montée en capital", "Fiscalité & conformité"],
      },
    ],
...
const programSeeds: ProgramSeed[] = [
  // Programmation
  { title: "Programmation Python", category: "Programmation", template: "programming", focus: "Python moderne" },
  { title: "React.js Frontend Pro", category: "Programmation", template: "programming", focus: "React.js" },
  { title: "PHP & SQL Fullstack", category: "Programmation", template: "programming", focus: "stack PHP + SQL" },
  { title: "React Native Mobile Apps", category: "Programmation", template: "programming", focus: "React Native" },
  { title: "Formation Complète Développement Web", category: "Programmation", template: "programming", focus: "développement web full-stack" },
  { title: "TypeScript Mastery", category: "Programmation", template: "programming", focus: "TypeScript" },
  { title: "JavaScript, Node.js & Algorithmique", category: "Programmation", template: "programming", focus: "JavaScript & algorithmique" },
  { title: "Node.js Express JWT & Mongoose", category: "Programmation", template: "programming", focus: "API Node.js sécurisée" },
  { title: "Unity 3D Game Builder", category: "Programmation", template: "programming", focus: "Unity 3D" },
  { title: "Java Applications", category: "Programmation", template: "programming", focus: "Java moderne" },
  { title: "Langage C Systèmes", category: "Programmation", template: "programming", focus: "langage C bas niveau" },
  { title: "Django REST & Admin", category: "Programmation", template: "programming", focus: "Django" },
  { title: "C++ Haute Performance", category: "Programmation", template: "programming", focus: "C++" },
  { title: "Essentiels de VS Code", category: "Programmation", template: "programming", focus: "workflow VS Code" },
  { title: "PowerShell Automation", category: "Programmation", template: "programming", focus: "scripts PowerShell" },
  // Data & BI
  { title: "PostgreSQL Architecture", category: "Data & BI", template: "data", focus: "PostgreSQL" },
  { title: "Power BI Dashboards", category: "Data & BI", template: "data", focus: "Power BI" },
  { title: "Data Science & Machine Learning", category: "Data & BI", template: "data", focus: "data science & ML" },
  { title: "Bases de Données Modernes", category: "Data & BI", template: "data", focus: "bases SQL & NoSQL" },
  // DevOps & Cloud
  { title: "Amazon Web Services (AWS)", category: "DevOps & Cloud", template: "devops", focus: "AWS cloud" },
  { title: "Docker & Kubernetes", category: "DevOps & Cloud", template: "devops", focus: "Docker & Kubernetes" },
  // Intelligence Artificielle
  { title: "IA Fullstack avec Ollama", category: "Intelligence Artificielle", template: "ai", focus: "stack Ollama + LangChain" },
  { title: "ChatGPT & Midjourney Studio", category: "Intelligence Artificielle", template: "ai", focus: "ChatGPT & Midjourney" },
  { title: "Formation DeepSeek", category: "Intelligence Artificielle", template: "ai", focus: "DeepSeek" },
  { title: "Intégrer l'IA dans votre Business", category: "Intelligence Artificielle", template: "ai", focus: "transformation IA business" },
  { title: "NoCode & Perplexity Automations", category: "Intelligence Artificielle", template: "ai", focus: "NoCode & Perplexity" },
  { title: "Créer du Contenu à Succès avec l'IA", category: "Intelligence Artificielle", template: "ai", focus: "contenu IA" },
  { title: "Qualité Logicielle & IA avec ChatGPT", category: "Intelligence Artificielle", template: "ai", focus: "qualité logicielle assistée par IA" },
  { title: "LLMs & Agents Experts", category: "Intelligence Artificielle", template: "ai", focus: "LLMs avancés" },
  // Réseaux & Infrastructure
  { title: "CCNA Booster", category: "Réseaux & Infrastructure", template: "network", focus: "CCNA" },
  { title: "Cisco Specialist", category: "Réseaux & Infrastructure", template: "network", focus: "Cisco avancé" },
  { title: "Fondements des Réseaux", category: "Réseaux & Infrastructure", template: "network", focus: "fondamentaux réseaux" },
  { title: "Protocoles OSI & TCP/IP", category: "Réseaux & Infrastructure", template: "network", focus: "protocoles OSI & TCP/IP" },
  { title: "Administrateur Réseaux", category: "Réseaux & Infrastructure", template: "network", focus: "administration réseau" },
  // Linux & Systèmes
  { title: "Linux Shell Bash", category: "Linux & Systèmes", template: "linux", focus: "Bash & scripting" },
  { title: "Linux Sécurité", category: "Linux & Systèmes", template: "linux", focus: "sécurité Linux" },
  { title: "Commandes du Terminal", category: "Linux & Systèmes", template: "linux", focus: "commandes terminal" },
  { title: "Linux de A à Z par la Pratique", category: "Linux & Systèmes", template: "linux", focus: "opérations Linux" },
  // Cybersécurité & Hacking
  { title: "Sécurité Réseaux", category: "Cybersécurité & Hacking", template: "security", focus: "sécurité réseaux" },
  { title: "CEH v13", category: "Cybersécurité & Hacking", template: "security", focus: "CEH v13" },
  { title: "Active Directory Red Team Lab", category: "Cybersécurité & Hacking", template: "security", focus: "Active Directory Red Team" },
  { title: "Cybersécurité avec l'IA", category: "Cybersécurité & Hacking", template: "security", focus: "cybersécurité + IA" },
  { title: "Ethical Hacking from Scratch", category: "Cybersécurité & Hacking", template: "security", focus: "ethical hacking" },
  { title: "OpenSSL Cryptage des Données", category: "Cybersécurité & Hacking", template: "security", focus: "OpenSSL & chiffrement" },
  { title: "Essentiel de Kali Linux", category: "Cybersécurité & Hacking", template: "security", focus: "Kali Linux" },
  { title: "Hacking WordPress", category: "Cybersécurité & Hacking", template: "security", focus: "WordPress pentest" },
  { title: "Wireshark Expert", category: "Cybersécurité & Hacking", template: "security", focus: "Wireshark" },
  // Business & Marketing
  { title: "Community Management Pro", category: "Business & Marketing", template: "business", focus: "community management" },
  { title: "Digital Marketing 360", category: "Business & Marketing", template: "business", focus: "marketing digital" },
  { title: "Dropshipping Accéléré", category: "Business & Marketing", template: "business", focus: "dropshipping" },
  { title: "E-commerce Rentable", category: "Business & Marketing", template: "business", focus: "e-commerce" },
  { title: "Créer & Administrer une Chaîne YouTube", category: "Business & Marketing", template: "business", focus: "gestion chaîne YouTube" },
  { title: "Shorts YouTube Rentables", category: "Business & Marketing", template: "business", focus: "shorts YouTube" },
  { title: "The Business Legion", category: "Business & Marketing", template: "business", focus: "The Business Legion" },
  // Compétences Complémentaires
  { title: "Comptabilité Générale", category: "Compétences Complémentaires", template: "skills", focus: "comptabilité" },
  { title: "Sage 100 Immobilisations", category: "Compétences Complémentaires", template: "skills", focus: "Sage 100" },
  { title: "Anglais Professionnel", category: "Compétences Complémentaires", template: "skills", focus: "anglais business" },
  { title: "Figma Design Systems", category: "Compétences Complémentaires", template: "skills", focus: "design Figma" },
  { title: "Canva Créatif", category: "Compétences Complémentaires", template: "skills", focus: "Canva" },
  { title: "Windows 11 Pro", category: "Compétences Complémentaires", template: "skills", focus: "Windows 11" },
  { title: "Windows Server Administration", category: "Compétences Complémentaires", template: "skills", focus: "Windows Server" },
  { title: "Suite Office Productivité", category: "Compétences Complémentaires", template: "skills", focus: "Microsoft Office" },
  { title: "Design UX/UI", category: "Compétences Complémentaires", template: "skills", focus: "UX/UI design" },
  // Trading & Finance
  { title: "Trading Crypto", category: "Trading & Finance", template: "trading", focus: "trading crypto" },
  { title: "Forex Pro", category: "Trading & Finance", template: "trading", focus: "trading Forex" },
  { title: "Smart Money Concepts (SMC)", category: "Trading & Finance", template: "trading", focus: "SMC" },
  { title: "Alti Trading", category: "Trading & Finance", template: "trading", focus: "Alti trading" },
  { title: "Investisseur Boursier", category: "Trading & Finance", template: "trading", focus: "investissement boursier" },
  { title: "Scalper Pro", category: "Trading & Finance", template: "trading", focus: "scalping pro" },
  { title: "Crypto Futures Mastery", category: "Trading & Finance", template: "trading", focus: "crypto futures" },
  { title: "Young Trader Forex Program", category: "Trading & Finance", template: "trading", focus: "Young Trader Forex" },
]
...
const metadataOverrides: Record<
  string,
  Partial<Pick<TrainingProgram, "level" | "duration" | "price" | "rating" | "students" | "reviews">>
> = {
...
export const trainingPrograms: Record<string, TrainingProgram> = programSeeds.reduce((acc, seed) => {
