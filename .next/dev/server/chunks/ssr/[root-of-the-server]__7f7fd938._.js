...
async function TrainingDetailPage({ params }) {
    ...
    const price = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getPriceBreakdown"])(training.price);
    if (!training) {
